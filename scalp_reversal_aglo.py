...
def initialize(context):
    ...
    context.assets = context.securities
    ...
    context.take_profit = 0.000001
    context.stop_loss = 0.000001
...
##################################################################
# def my_minute_take_profit(asset, context, data):
#     """ this function is called on every minute update. """
#     px = data.current(asset, 'close')
#     move = (px-context.entry_price[asset])/context.entry_price[asset]
#     if move > 0.30:
#         order_target(asset, 0)     
